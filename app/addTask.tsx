...
const AddTaskScreen = () => {
    ...
    async function handleSaveTask() {
        ...
        console.log("handlesavetask",type, dueDate);
        ...
        try {
            ...
            if (!householdId) {
                ...
                let localTasks: TaskProps[] = cachedLocal
                                ...
                                <TouchableOpacity
                                    ...
                                    style={[
                                        themedStyles.input,
                                        {
                                            flex: 1,
                                            backgroundColor:
                                                difficulty === diff ? theme.tint : theme.avatarBg,
                                        },
                                    ]}
                                    onPress={() =>
                                        setDifficulty(diff as "facile" | "moyen" | "difficile")
                                    }
                                >
                                    <Text
                                        style={{
                                            color:
                                                difficulty === diff ? theme.background : theme.text,
                                            textAlign: "center",
                                        }}
                                    >
